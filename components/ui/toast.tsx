...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed inset-x-0 bottom-0 z-[100] mx-auto flex w-full max-w-sm flex-col gap-2 p-4 outline-none sm:left-auto sm:right-0 sm:top-0 sm:max-w-md sm:flex-col sm:p-6",
      className
    )}
    {...props}
  />
